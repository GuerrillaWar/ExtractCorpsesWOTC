...
var localized string ExtractionFlyover;
...
simulated function DeployFultonHarness_BuildVisualization(XComGameState VisualizeGameState)
{
	local XComGameStateHistory          History;
	...
	foreach VisualizeGameState.IterateByClassType(class'XComGameState_Unit', GameStateUnit)
	{
		...
		SoundAction = X2Action_PlaySoundAndFlyOver( class'X2Action_PlaySoundAndFlyOver'.static.AddToVisualizationTree(ActionMetadata, VisualizeGameState.GetContext()/*, false, ActionMetadata.LastActionAdded*/));
		SoundAction.TheSoundCue = SoundCue'XPACK_SoundEnvironment.Crate_Extract_XCOM_Cue';
		SoundAction.LookAtDuration = 1.0f;
		SoundAction.DelayDuration = 0.0f;
		SoundAction.CharSpeech = '';
		SoundAction.FlyOverMessage = default.ExtractionFlyover;
		SoundAction.FlyOverIcon = "img:///ExtractCorpses_Assets.UIPerk_FultonExtract";
		...
		PlayEffectAction.EffectName = "FX_Fulton_Balloon.P_Fulton_Balloon";
		PlayEffectAction.EffectLocation = vect(0,0,0);
		PlayEffectAction.AttachToSocketName = 'FX_Chest';
		...
		class'ExtractCorpses_Action_FultonExtraction'.static.AddToVisualizationTree(ActionMetadata, VisualizeGameState.GetContext(), false, PlayEffectAction); 
	}
	//****************************************************************************************
}
